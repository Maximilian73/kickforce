...
class eCrop
{
	...
	private function createThumbImageResource()
	{
		...
		if (in_array($this->sourceMime, $this->imgTypesAlpha))
		{
			imagealphablending($this->thumbImageResource, false); 
			imagesavealpha($this->thumbImageResource, true); 
		}
