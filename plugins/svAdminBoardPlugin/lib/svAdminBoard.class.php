<?php
/**
 * svAdminBoard main class
 *
 * @package    plugins
 * @subpackage svAdminBoard
 * @author     kevin
 * @version    SVN: $Id: svAdminBoard.class.php 25249 2009-12-11 09:50:42Z Crafty_Shadow $
 */ 
class svAdminBoard 
{
  ...
  */
  public static function getItems()
  {
    ...
    array_walk($items, 'svAdminBoard::initItem');
  ...
  */
  ...
  {    
    ...
    foreach ($categories as $category_name => $category_data)
    {
      ...
      {            
        array_walk($categories[$category_name]['items'], 'svAdminBoard::initItem');
      }
    }
  ...
  */
  ...
  {
    return sfConfig::get('app_sv_admin_board_'.$name, $default);
  }
