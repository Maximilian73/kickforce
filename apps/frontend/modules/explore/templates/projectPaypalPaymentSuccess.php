        ...
        <section class="row-fluid">
            <section class="span9 fund_rasising_listing" id="fund_rasising_listing">  
                ...
                <figure class="span12 first outer_lyr" id="project_contet">
                    <div class="inner_lyr">
                        <h3>Data Credit Card</h3>
                        <!-- Content -->
                        <form action="<?php echo url_for('explore_paypal_payment',$project); ?>" method="post">
                            <?php echo $form; ?>
                            <br /><br />
                            <a class="btn btn-primary" href="<?php echo url_for('explore_paypal_calculate',$project);?>">Back</a>
                            <input type="submit" class="btn btn-warning" value="Payment" name="submit">
                        </form>
                        <!-- End Content -->
                    </div>
                </figure>
