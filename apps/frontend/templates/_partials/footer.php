<?php include_partial('global/partials/hidden_sections');?>	
    ...
    <section class="footer_2">
        <section class="container-fluid container">
            <section class="row-fluid">
                <figure class="span6" id="footer_left"><i class="icon-mobile-phone"></i><span> +38 095 909 67 30</span><i class="icon-envelope-alt"></i><span>altainmet@gmail.com</span></figure>
            ...
            <section class="row-fluid">
                <figure class="span6" id="footer_left">
                    <ul class="footer_nav"> 
                        ...
                        <li><a href="event_venue.html">Events</a></li>
                        <li><a href="contact_us.html">Contact Us</a></li>
                    </ul>
                    <p> Copyright © 2014 - Kickforce crowdfuning style</p>
                </figure>
                <figure class="span6" id="footer_right">
                    <div id="tweets" class="latest_tweets">
                        <ul id="latest_tweets">
                            <li> Have a look start page <a href="<?php echo url_for('@homepage'); ?>">Home</a></li>
                        </ul>
                    </div>
                </figure>
            </section>
