...
//        $mcImageManagerConfig['general.tools'] = "upload"; // "filemanager" button if you have "filemanager.urlprefix" configured.
        ...
        $user_id = ($_COOKIE['user_id'])?'assets/'.$_COOKIE['user_id'].'/':'';

        $mcImageManagerConfig['filesystem'] = "Moxiecode_LocalFileImpl";
        $mcImageManagerConfig['filesystem.path'] = '../../../../uploads/'.$user_id; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../uploads/'.$user_id; // absolute or relative from this script path, required.
        ...
        $mcImageManagerConfig['upload.max_width'] = "600"; // Only if force_width_height is true
