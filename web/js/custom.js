jQuery(document).ready(function ($) {
    ...
    if (productslider.length) {
       productslider.bxSlider({ slideWidth: 270, minSlides: 1, maxSlides: 4, slideMargin: 10 });
    }

	var productslider1 = $('#slider_products1');
    if (productslider1.length) {
       productslider1.bxSlider({  slideWidth: 270, minSlides: 1, maxSlides: 4, slideMargin: 10 });
    }
