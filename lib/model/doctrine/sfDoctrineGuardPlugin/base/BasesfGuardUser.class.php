 ...
 * @method sfGuardUser           setProject()               Sets the current record's "Project" collection
 * @method sfGuardUser           setAmount()                Sets the current record's "Amount" collection
 * 
 * @package    Kickforce
 * @subpackage model
...
abstract class BasesfGuardUser extends sfDoctrineRecord
{
    ...
    {
        $this->setTableName('force_guard_user');
